  ...
  return (
    <div ref={ref} className="about-container">
      <div className="about-text">
        <h2>About me</h2>
        <p>
            I'm currently a 19-year-old Full Stack Developer student at Henry.
            ...
            These skills have helped me to become a better developer and work more efficiently in a team.
        </p>
      </div>
    </div>
  );
